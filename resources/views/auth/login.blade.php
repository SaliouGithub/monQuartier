...
<head>
  ...
  <title>Login - Mon quartier</title>
                  ...
                  @csrf
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="email" :value="old('email')" class="form-control" id="email" required autofocus autocomplete="username">
                        <div class="invalid-feedback">S'il vous plaît entrez votre e-mail.</div>
                        @error('email')
                    ...
                    @if(session('status') == 'failed')
                      <div class="text-danger">Adresse e-mail ou mot de passe non valide.</div>
                    @endif
